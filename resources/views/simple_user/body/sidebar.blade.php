...
<div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
    ...
    <div class="d-flex flex-column justify-content-between h-100">
        <ul class="sidebar-nav" data-coreui="navigation">
            <li class="nav-item"><a class="nav-link" href="{{ route('user.dashboard', $user) }}">
                    <svg class="nav-icon">
                        <use xlink:href="{{ asset('dashboard/vendors/@coreui/icons/svg/free.svg#cil-speedometer')}}"></use>
                    </svg> Dashboard</a>
            </li>
            <li class="nav-item"><a class="nav-link" href="{{ route('user.clients', $user) }}">
                    <svg class="nav-icon">
                        <use xlink:href="{{ asset('dashboard/vendors/@coreui/icons/svg/free.svg#cil-newspaper')}}"></use>
                    </svg> Clients</a>
            </li>
            <li class="nav-item"><a class="nav-link" href="{{ route('user.projects', $user) }}">
                    <svg class="nav-icon">
                        <use xlink:href="{{ asset('dashboard/vendors/@coreui/icons/svg/free.svg#cil-copy')}}"></use>
                    </svg> Projects</a>
            </li>
            <li class="nav-item"><a class="nav-link" href="{{ route('user.tasks', $user) }}">
                    <svg class="nav-icon">
